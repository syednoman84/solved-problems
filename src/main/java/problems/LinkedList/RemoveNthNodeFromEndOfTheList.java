...
public class RemoveNthNodeFromEndOfTheList {
    ...
    public static void main(String[] args) {
        RemoveNthNodeFromEndOfTheList solution = new RemoveNthNodeFromEndOfTheList();
        
        // Test case 1: head = [1], n = 1
        ListNode head1 = new RemoveNthNodeFromEndOfTheList().new ListNode(1);
