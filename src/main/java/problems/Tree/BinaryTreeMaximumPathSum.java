...
public class BinaryTreeMaximumPathSum {
    ...
    public static void main(String[] args) {
        ...
        TreeNode root1 = new BinaryTreeMaximumPathSum().new TreeNode(1);
        root1.left = new BinaryTreeMaximumPathSum().new TreeNode(2);
        root1.right = new BinaryTreeMaximumPathSum().new TreeNode(3);
